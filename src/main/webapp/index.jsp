...
<%@ page import="java.util.List,com.tap.model.Resturant,com.tap.daoImpl.ResturantDaoImpl" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<section class="menu">
        ...
        <header><div class="logo"><h1>TapFoods</h1></div></header>
                    ...
                    <ul>
                        <li><a href="HomeControler"><i class='bx bxs-home-smile'>Home</i></a></li>
...
<section class="category">
        <div class="list-items">
            ...
            <div class="card-list">
                <div class="card">
                    <a href="signIn.jsp"><img src="images\ckloli.jpg"></a>
                    <div class="food-title">
                        <h1>Chicken</h1>
                    </div>
                </div>
                <div class="card">
                    <a href="signIn.jsp"><img src="images\bx2.jpg"></a>
                    <div class="food-title">
                        <h1>Burger</h1>
                    </div>
                </div>
                <div class="card">
                    <a href="signIn.jsp"><img src="images\px1.jpg"></a>
                    <div class="food-title">
                        <h1>Pizza</h1>
                    </div>
                 </div>
                <div class="card">
                    <a href="signIn.jsp"><img src="images\dx1.jpg"></a>
                    <div class="food-title">
                        <h1>Dessert</h1>
                    </div>
                </div>
    ...
    <hr style="border:none;height:2px;background-color: rgb(227, 227, 219); margin-top: 20px;margin-left:50px;margin-right:50px;">
    ...
    <%
       ResturantDaoImpl restImpl = new ResturantDaoImpl();
	   List<Resturant> allResturanrt = restImpl.getAllResturanrt();
	   request.setAttribute("resturant", allResturanrt);
	 %>
    <main>
                    ...
                    <a href="MenuControler?rId=<%= restaurant.getResturantId() %>" style=" text-decoration: none; color:black;">
                       <div class="restaurant-card">
                           ...
                           <div class="restaurant-details">
                               <h3><%= restaurant.getName() %><i class='bx bxs-calendar-star' style="margin-left:50px;"><%= restaurant.getRating() %></i></h3>
                               <p>  <%= restaurant.getCusineType() %> , <%= restaurant.getAddress() %></p>
                               <pre > <i class='bx bx-time-five'><%= restaurant.getEta() %></i>  <%= restaurant.isActive() %></pre>
                           </div>
                       </div>
            </a>
            <%} } %>
